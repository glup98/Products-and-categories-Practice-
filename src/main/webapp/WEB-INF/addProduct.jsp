...
<body>
    <div class="m-3">
        <a class="m-3" href="/">Dashboard</a> <a class="m-3" href="/categories">Categories</a>
    </div>
    ...
    <form:form class="d-inline-block" action="/categories/${id}" method="post" modelAttribute="category">
